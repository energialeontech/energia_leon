...
export default function ContactForm({ variant = "full" }: ContactFormProps) {
  ...
  if (enviado) {
    return (
      ...
      >
        ...
        <h3 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: "1.375rem", color: "#8B1A1A", marginBottom: "0.5rem" }}>
          ¡Mensaje recibido!
        </h3>
        <p style={{ color: "#6B7280", fontSize: "0.95rem", maxWidth: "360px", margin: "0 auto" }}>
          Nos pondremos en contacto contigo en menos de 24 horas. También puedes escribirnos directamente por WhatsApp.
        </p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} noValidate>
      ...
      <p style={{ fontSize: "0.75rem", color: "#9CA3AF", marginTop: "0.875rem", textAlign: "center" }}>
